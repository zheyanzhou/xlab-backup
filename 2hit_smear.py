...
# 4. CZT calo smearing (fix the fano factor and variant energy sigma based on edep)
from Configurables import CaloHitSmearAlg
caloSmearAlg = CaloHitSmearAlg("CaloSmearAlg")
caloSmearAlg.inHits.Path = "CaloSimHits"
caloSmearAlg.outHits.Path = "CaloHits"
caloSmearAlg.energy_reference = 662 # keV
caloSmearAlg.resolution_reference = 3 # relative resolution
...
outAlg.filename = 'compton_hit_smear.root'
